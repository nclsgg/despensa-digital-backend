...
type GenerateAIShoppingListDTO struct {
	...
	TotalBudget     float64   `json:"total_budget" binding:"required,min=0"`
	ShoppingType    string    `json:"shopping_type" binding:"required,oneof=weekly monthly stock_up emergency"`
	IncludeBasics   bool      `json:"include_basics" binding:"required"`
